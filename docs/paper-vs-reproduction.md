...
- 把 Q-PAS 的状态空间从 4 个符号组合扩到带**幅度**的分档（当前只有二值即时奖励，
  per-seed oracle 达 0.87058 而 Q-PAS 最好 0.82795，gap 仍在）；
- 论文的动作空间 {5,10,15,20} **排除了本项目实测的最优档 T=50**（0.83990 vs T=10 的 0.82309，
  p=0.019\*）——这是 Q-PAS 天花板的直接来源。
